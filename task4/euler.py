...
lnnType=['Seq','SeqCone','ResNet','ResNet-OG','ResNet-PA','ResNet-OGx2','ResNet-PAx2']
lblocks=[2,3]
lnodes=[512,1024]

literate = itertools.product(lnnType,lblocks,lnodes)

nepoch =500
nbatchsize = 32
nvalidation = 0.33

for innType, iblocks, inodes in literate:
    
    nn,nname = CreateNeuralNet(nnType=innType,blocks=iblocks,nodes=inodes)
