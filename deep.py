...
NN1 (960,480,240,120) comp 2 span 8 layers 4 dropout 0.5 batch 128 epoch 200 
'''


model_nn = Sequential()
model_nn.add(Dense(int(nnodes/ncompress**0), input_dim=nfeatures, kernel_initializer='random_uniform', bias_initializer='zeros' ))
model_nn.add(BatchNormalization())
model_nn.add(Activation('relu'))
model_nn.add(Dropout(ndropout))
model_nn.add(Dense(int(nnodes/ncompress**1), kernel_initializer='random_uniform', bias_initializer='zeros' ))
model_nn.add(BatchNormalization())
model_nn.add(Activation('relu'))
model_nn.add(Dropout(ndropout))
model_nn.add(Dense(int(nnodes/ncompress**2), kernel_initializer='random_uniform', bias_initializer='zeros' ))
model_nn.add(BatchNormalization())
model_nn.add(Activation('relu'))
model_nn.add(Dropout(ndropout))
if nlayers == 4 :
    model_nn.add(Dense(int(nnodes/ncompress**3), kernel_initializer='random_uniform', bias_initializer='zeros' ))
    model_nn.add(BatchNormalization())
    model_nn.add(Activation('relu'))
    model_nn.add(Dropout(ndropout))
