...
nn,nname = CreateNeuralNet(nnType='SeqCone',blocks=3,nodes=960, useBias=True)
nn.summary()
if False : nn.summary();  plot_model(nn, to_file='test'+nname+'.png', show_shapes=True, show_layer_names=False)  

#%%
nepoch =400
nbatchsize = 32
nvalidation = 0
nclassweight = {0: 2, 1: 0.5, 2: 1, 3: 0.5, 4: 2}
history = LossHistory() 
...
nn.fit(x_train, y_train, verbose = 2, shuffle = True,
       ...
       callbacks=[history], validation_split=nvalidation ,class_weight=nclassweight
       )
